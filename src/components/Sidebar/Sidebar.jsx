    ...
    return (
        <>
            ...
            <button
                ...
                className="fixed top-3 md:top-5 left-2 md:left-4 z-50 p-1.5 md:p-2 rounded-lg bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 shadow-sm hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors"
                aria-label="Open menu"
            >
                <Menu size={18} className="md:w-5 md:h-5 text-gray-700 dark:text-gray-200" />
            </button>
            ...
            >
                ...
                <div>
                    ...
                    <div className="flex items-center gap-3 cursor-pointer px-4 pb-6 border-b border-gray-100 dark:border-gray-800 mb-4">
                        ...
                        <ChevronDown size={16} className="text-gray-400 ml-auto hidden" />
                    </div>
                    ...
                    <nav className="flex flex-col gap-1 px-3">
                        <a
                            ...
                            className={`flex items-center gap-3 px-3 py-2.5 rounded-lg font-medium transition-colors ${pathname === "/dashbord"
